...
Output a JSON object containing a list of floating-point numbers, representing players' heights.
'''

nba_pairwise_comparison_prompt_template = '''Which nba player is taller: {key1} or {key2}? 
Output the name of the taller player, breaking tie by selecting the player whose name comes second alphabetically.
'''

nba_external_comparison_prompt_template = '''Given a list of nba players: {keys}
Use your own knowledge to sort the players in ascending order based on heights and player name.
Output a JSON object containing a list of player names sorted in ascending order,
'''
